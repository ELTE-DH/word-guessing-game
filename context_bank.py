...
class ContextBank:
    ...
    def read_all_sentences_for_word(self, displayed_sents: list, window_size: int = 11, hide_word=True,
                                    hide_char: str = 'X'):
        ...
        word = self.identify_word_from_id(displayed_sents)
    ...
    def identify_word_from_id(self, displayed_sents):
